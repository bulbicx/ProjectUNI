  ...
  constructor(props) {
    ...
    this.appointmentForm = connectProps(AppointmentFormContainer, () => {
      ...
      const currentAppointment = data
        .filter(appointment => editingAppointment && appointment._id === editingAppointment.id)[0]
        || addedAppointment;
    ...
    this.setState((state) => {
      ...
      if (changed) {
        data = data.map(appointment => (
          changed[appointment.id] ? { ...appointment, ...changed[appointment._id] } : appointment));
      }
