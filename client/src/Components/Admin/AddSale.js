    ...
    return (
        <div className={classes.main_container}>
            <Breadcrumb>
                ...
                <BreadcrumbItem active>Add Sale</BreadcrumbItem>
            </Breadcrumb>
            <div className={classes.title_section_edit}>
                <span>
                    <img src={saleIcon} alt="Sale edit icon" />
                </span>
                <h3 className={classes.title_edit}>Add Sale</h3>
            </div>
                ...
                <FormControl 
                    ...
                    <option aria-label="None" value="" />
                    {
                        properties.map(property => {
                            return (
                                <option key={property._id} value={property._id}>{property.propertyName} ({property.category})</option>
                            )
                        })
                    }
                    </Select>
                ...
                <br />
                    ...
                    <div style={{display: 'flex', justifyContent: 'center'}}>
                        <div className={classes.btn_submit_setion}>
                            ...
                            <button 
                            className={classes.btn_submit_form} onClick={(e) => submitHandler(e)}>Add Sale</button>
                        </div>
                    </div>
                        {
                            isLoading && 
