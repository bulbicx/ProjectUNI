...
import img_card from '../../assets/images/person3.jpg'
    ...
    return (
        <div className={classes.container}>
            <div className={classes.first_section}>
                ...
                <h2 className={classes.h2}>We help renters along the way</h2>
                <p className={classes.p}>Our team of experts is in constant communication with the
                renters. We help them on fulfilling their needs, we ease their process on finding the place they wish.</p>
            </div>
                ...
                <Card className={classes.root}>
                    <CardActionArea>
                        ...
                        <CardContent>
                            ...
                            Micheal has won best seller month challenge in the Crystal Palace area. Discover who might be your personal agent!
                            </Typography>
                        </CardContent>
                    </CardActionArea>
